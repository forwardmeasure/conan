...
function get_env_script_spec()
{
	...
	COMPUTE_ENINE_TYPE=""
	get_compute_engine_type 'COMPUTE_ENINE_TYPE'
	echo "Determined compute engine type to be $COMPUTE_ENINE_TYPE"
	...
	env_script_spec="$GCC_MAJOR_VERSION-$COMPUTE_ENINE_TYPE-$OPTIM_LEVEL"
}
