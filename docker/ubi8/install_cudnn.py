...
_cudnn_version_archive_map = {
'7.6.5': 'cudnn-10.2-linux-x64-v7.6.5.32.tgz'}
...
def get_cudnn_download_location(version):
    ...
    return (archive_name, "http://developer.download.nvidia.com/compute/redist/cudnn/v{}/{}".format(version, archive_name))
...
if __name__ == "__main__":
    ...
    download_and_install_cudnn(cmd_line_args.cudnn_version, cmd_line_args.cudnn_build_dir, cmd_line_args.cudnn_install_dir)
