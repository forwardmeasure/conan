...
import os
from conans import AutoToolsBuildEnvironment, tools, CMake

from forwardmeasure.conan_utils import ConfigurableConanFile


class ApacheAprUtilConan(ConfigurableConanFile):
    (
        name,
        version,
        dependencies,
    ...
    def requirements(self):
        self.requires(self.dependencies["apache-apr"])
        self.requires(self.dependencies["expat"])
