...
class BoostConan(ConanFile):
    ...
    default_options.append("bzip2:shared=True")
    default_options.append("zlib:shared=True")
    ...
    def configure(self):
        if self.zip_bzip2_requires_needed:
            self.requires("bzip2/1.0.6@forwardmeasure/stable")
            self.requires("zlib/1.2.11@forwardmeasure/stable")
...
# Boost 1.70 value           sha256 = "48f379b2e90dd1084429aae87d6bdbde9670139fa7569ee856c8c86dd366039d"
            sha256 = "d074bcbcc0501c4917b965fc890e303ee70d8b01ff5712bae4a6c54f2b6b4e52"
            extension = ".zip"
        else:
# Boost 1.70 value           sha256 = "882b48708d211a5f48e60b0124cf5863c1534cd544ecd0664bb534a4b5d506e9"
